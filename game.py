...
cactus_img = pygame.image.load('D:/cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('D:/fire_bricks.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('D:/dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('D:/fireball.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('D:/maryo.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('D:/mario_dies.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('D:/end.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('D:/start.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('D:/mario_theme.wav')
